import 'dart:convert';
import 'package:agora_shop/models/categories/CategoryModel.dart';
import 'package:http/http.dart' as http;
import '../../shared/errors/exceptions.dart';
import 'api_constants.dart';

abstract class CategoryApiService {
  Future<List<CategoryModel>> getCategoriesApi(String token);
}

class CategoryApiServiceImpWithHttp implements CategoryApiService {
  final http.Client client;
  CategoryApiServiceImpWithHttp({required this.client});
  @override
  Future<List<CategoryModel>> getCategoriesApi(String token) async {
    var categories = [
      {
        'id': 1,
        'name': 'Electronics',
    ...
    //     .get(Uri.parse('${ApiConstants.baseUrl}/categories/'), headers: {
    ...
    //   final List<CategoryModel> postModels =
