...
class DetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: GetBuilder<HomeController>(builder: (_) {
      return HandlingErrors.pageErrorHandling(
          isCircleShown: homeController.isProductCircleShown,
          isNoInternetConnection: homeController.isProductNoInternetConnection,
          onTapTry: () async {
            homeController.showProductCircleIndicator();
          ...
          page: GetBuilder<ProductDetailsController>(builder: (_) {
            return Scaffold(
              body: ListView(
                children: [
                  Stack(
